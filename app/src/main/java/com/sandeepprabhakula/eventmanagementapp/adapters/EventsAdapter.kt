...
class EventsAdapter(options: FirestoreRecyclerOptions<EventDetails>,private val listener :OnClickEventDetails) :
    FirestoreRecyclerAdapter<EventDetails, EventsAdapter.EventViewHolder>(
        options
    ) {
...
interface OnClickEventDetails{
    fun onEventDetailsClicked(eventName:String)
}